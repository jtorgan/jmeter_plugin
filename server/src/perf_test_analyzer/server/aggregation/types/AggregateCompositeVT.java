...
public final class AggregateCompositeVT extends AbstractCompositeVT {
	...
	public String getDescription(final ChartSettings chartSettings) {
		...
		if (buildType != null && getKey() != null) {
			title = buildType.getCustomDataStorage(PluginConstants.STORAGE_ID_SAMPLE_ALIAS).getValue(getKey());
		}
