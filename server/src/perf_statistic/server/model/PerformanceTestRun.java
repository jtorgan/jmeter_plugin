...
public class PerformanceTestRun implements Comparable<PerformanceTestRun> {
	...
	private Map<String, Long> myResponseCodes;
	...
	public Map<String, Long> getResponseCodes() {
		return myResponseCodes;
	}

	public void addResponseCode(String code) {
		if (myResponseCodes == null) {
			myResponseCodes = new HashMap<String, Long>();
		}
		Long codeCount = myResponseCodes.get(code);
		myResponseCodes.put(code, codeCount == null ? 1 : ++codeCount);
	}
