...
public class PerformanceStatisticsPublisher implements BuildFinishAware, ValueProvider {
	...
	public PerformanceStatisticsPublisher(final BuildDataStorage storage, final ValueProviderRegistry registry) {
		myStorage = storage;
...
//					String[] sampleParts = sharp_pattern.split(testName);
